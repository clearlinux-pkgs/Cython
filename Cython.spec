...
Source0  : https://files.pythonhosted.org/packages/d3/38/adc49a5aca4f644e6322237089fdcf194084f5fe41445e6e632f28b32bf7/Cython-0.29.22.tar.gz
...
%prep
%setup -q -n Cython-0.29.22
cd %{_builddir}/Cython-0.29.22
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614009461
...
cp %{_builddir}/Cython-0.29.22/COPYING.txt %{buildroot}/usr/share/package-licenses/Cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.22/LICENSE.txt %{buildroot}/usr/share/package-licenses/Cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
