...
Source0  : https://files.pythonhosted.org/packages/d9/cd/0d2d90b27219c07f68f1c25bcc7b02dd27639d2180add9d4b73e70945869/Cython-0.29.23.tar.gz
...
%prep
%setup -q -n Cython-0.29.23
cd %{_builddir}/Cython-0.29.23
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1618447967
...
cp %{_builddir}/Cython-0.29.23/COPYING.txt %{buildroot}/usr/share/package-licenses/Cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.23/LICENSE.txt %{buildroot}/usr/share/package-licenses/Cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
