...
#
# Source0 file verified with key 0xB3B998CCF39A065B (stefan@behnel.de)
#
Name     : Cython
Version  : 0.26.1
Release  : 34
URL      : http://pypi.debian.net/Cython/Cython-0.26.1.tar.gz
Source0  : http://pypi.debian.net/Cython/Cython-0.26.1.tar.gz
Source99 : http://pypi.debian.net/Cython/Cython-0.26.1.tar.gz.asc
...
export LANG=C
export SOURCE_DATE_EPOCH=1505709529
