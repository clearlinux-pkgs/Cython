...
%prep
%setup -q -n Cython-0.29.15
cd %{_builddir}/Cython-0.29.15
...
cp %{_builddir}/Cython-0.29.15/COPYING.txt %{buildroot}/usr/share/package-licenses/Cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.15/LICENSE.txt %{buildroot}/usr/share/package-licenses/Cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
