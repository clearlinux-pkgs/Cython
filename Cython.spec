...
Source0  : https://files.pythonhosted.org/packages/79/36/69246177114d0b6cb7bd4f9aef177b434c0f4a767e05201b373e8c8d7092/Cython-0.29.19.tar.gz
...
%prep
%setup -q -n Cython-0.29.19
cd %{_builddir}/Cython-0.29.19
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590022224
...
cp %{_builddir}/Cython-0.29.19/COPYING.txt %{buildroot}/usr/share/package-licenses/Cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.19/LICENSE.txt %{buildroot}/usr/share/package-licenses/Cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
