...
Source0  : https://files.pythonhosted.org/packages/49/8a/6a4135469372da2e3d9f88f71c6d00d8a07ef65f121eeca0c7ae21697219/Cython-0.29.16.tar.gz
...
%prep
%setup -q -n Cython-0.29.16
cd %{_builddir}/Cython-0.29.16
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585146450
...
cp %{_builddir}/Cython-0.29.16/COPYING.txt %{buildroot}/usr/share/package-licenses/Cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.16/LICENSE.txt %{buildroot}/usr/share/package-licenses/Cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
