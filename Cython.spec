...
Source0  : https://files.pythonhosted.org/packages/4f/94/15b333b182ce12c76e2da888d608edd472f617bafcd8d1bb857c18faac3e/Cython-0.29.18.tar.gz
...
%prep
%setup -q -n Cython-0.29.18
cd %{_builddir}/Cython-0.29.18
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589843480
...
cp %{_builddir}/Cython-0.29.18/COPYING.txt %{buildroot}/usr/share/package-licenses/Cython/38099d4531dd3d32b72df546041f15201123547f
cp %{_builddir}/Cython-0.29.18/LICENSE.txt %{buildroot}/usr/share/package-licenses/Cython/a6a5418b4d67d9f3a33cbf184b25ac7f9fa87d33
